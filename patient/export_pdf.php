<?php
// patient/export_pdf.php - Экспорт медицинской записи в PDF из интерфейса пациента
...
// Проверяем, авторизован ли пользователь как пациент
session_start();
...
if ($medical_record['patient_id'] != $userid) {
...
log_medical_record_action($database, $userid, 'patient', $record_id, 'export', $action_details);
